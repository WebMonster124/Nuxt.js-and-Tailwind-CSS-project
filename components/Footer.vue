<template>
	<footer
		class="bg-gradient-to-b from-green-900 to-green-800 py-4 px-4 sm:px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64"
		aria-labelledby="footerHeading"
	>
		<h2 id="footerHeading" class="sr-only">Footer</h2>
		<div class="flex items-center justify-between">
			<div>
				<a href="/" class="font-black text-white text-2xl">
					Coffee Alternative
				</a>
			</div>		
			<div class="pt-6 pb-6">
		...
		<div class="mx-auto">
			<!-- <div class="xl:grid xl:grid-cols-3 xl:gap-8">
				<div class="grid grid-cols-2 gap-8 xl:col-span-2">
					<div class="md:grid md:grid-cols-2 md:gap-8">
						<div>
							<h3
								class="text-sm font-semibold text-green-200 tracking-wider uppercase"
							>
								Articles
							</h3>
			...
			<div
				class="border-t border-green-700 pt-8 md:flex md:items-center md:justify-between"
			>
				<div class="flex space-x-6 md:order-2">
					<a
						href="https://www.facebook.com/Coffee-Alternative-100121435362373"
						target="_blank"
					...
					<a
						href="https://www.instagram.com/coffee_alternative"
						target="_blank"
						class="text-gray-100 hover:text-gray-300"
					>
				...
				<p class="mt-8 text-xs uppercase text-gray-200 md:mt-0 md:order-1">
					&copy; {{ new Date().getFullYear() }}
					<a href="https://x.enterprises" class="white--text" target="_blank"
						>X Enterprises, LLC</a
					>. All Rights Reserved.
				</p>
			</div>
